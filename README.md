...
[Headline results](#headline-results) · [Quick start](#quick-start) · [Architecture](#architecture) · [Modules](#modules) · [Token optimisation](#token-optimisation-measured) · [Design choices](#design-choices) · [Testing](#testing) · [Layout](#repository-layout) · [Configuration](#configuration)
